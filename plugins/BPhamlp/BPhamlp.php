...
require_once 'lib/haml/HamlParser.php';

class BPhamlp extends BClass
{
    ...
    public static function bootstrap()
    {
        ...
        static::$_phpCodeDest = $config->get('fs/storage_dir').'/phamlp';
        BUtil::ensureDir(static::$_phpCodeDest);

        static::$_forceReparse = $config->get('modules/BPhamlp/force_reparse');
